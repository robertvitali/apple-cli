...
public enum AppleVersion {
    public static let current = "26.0.0" // release-preparation-managed, never hand-edited; first tag is v26.0.0 at D2 (platform-keyed — see AGENTS.md "Versioning + releases")
