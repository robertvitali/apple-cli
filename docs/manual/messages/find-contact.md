# apple messages find-contact

Fuzzy-search contacts by name/nickname; ranked candidates with confidence scores.

## Synopsis

```
apple messages find-contact <name>
```

## Options

- `<name>`
  <br>Name to search for.
