# apple messages check-availability

Check (history-based) whether a recipient has iMessage, else SMS fallback.

## Synopsis

```
apple messages check-availability <recipient>
```

## Options

- `<recipient>`
  <br>Phone or email to check.
