...
List event calendar collections (id/title/account/account_type/color/…).

## Synopsis

```
apple calendar calendars list [flags]
```

## Options

- `--account` `<account>`
  <br>Filter to collections in this account (source) name.
...
- [`apple calendar calendars`](./index.md)
