# apple contacts groups delete

Delete a group, members persist (requires APPLE_TEST_MODE=1, like the MCP). → delete_group

## Synopsis

```
apple contacts groups delete <identifier> [flags]
```
