# apple reminders subtasks toggle

Flip a subtask's completion (executes on call, like the MCP; --dry-run previews).

## Synopsis

```
apple reminders subtasks toggle [flags]
```

## Options

- `--reminder-id` `<reminder-id>`
  <br>Parent reminder identifier (required).
- `--subtask-id` `<subtask-id>`
  <br>Subtask identifier (required, lowercase hex).
...
- [`apple reminders subtasks`](./index.md)
