# apple mail analytics dashboard

Write a static HTML inbox dashboard (EXECUTES by default; --dry-run previews).

## Synopsis

```
apple mail analytics dashboard [flags]
```

## Options

- `--out` `<out>`
  <br>Output HTML path (default ./inbox-dashboard.html).
