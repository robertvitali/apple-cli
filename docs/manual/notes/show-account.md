# apple notes show-account

Reveal an account in the Notes.app UI by id.

## Synopsis

```
apple notes show-account [flags]
```

## Options

- `--id` `<id>`
  <br>Account id (from `accounts`).
- `--separately`
  <br>Open in a separate window.
