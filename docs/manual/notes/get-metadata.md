# apple notes get-metadata

[BETA] Read note metadata AppleScript can't expose (pinned, snippet, flags) from NoteStore.sqlite.

## Synopsis

```
apple notes get-metadata [flags]
```

## Options

- `--id` `<id>`
  <br>Note id (x-coredata://…/ICNote/pNNN).
