# apple notes create-folder

Create a folder, nested paths create intermediates (EXECUTES; --dry-run previews).

## Synopsis

```
apple notes create-folder <name> [flags]
```

## Options

- `<name>`
  <br>Folder name or nested path (A/B/C).
- `--account` `<account>`
