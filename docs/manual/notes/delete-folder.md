# apple notes delete-folder

Delete a folder AND EVERY NOTE IN IT, permanently (previews by default; --execute performs it).

## Synopsis

```
apple notes delete-folder <name> [flags]
```

## Options

- `<name>`
  <br>Folder name or nested path.
- `--account` `<account>`
