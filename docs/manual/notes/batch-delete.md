# apple notes batch-delete

Delete multiple notes by id to Recently Deleted, ≤500 (EXECUTES; --dry-run previews).

## Synopsis

```
apple notes batch-delete [flags]
```

## Options

- `--ids` `<ids>` *(repeatable)*
  <br>Note ids to delete.
