...
`guardOutbound` doc comment in that file plus the `AppleKit.AttachmentSource.resolve` doc comment
in `Sources/AppleKit/AttachmentSource.swift`** — the latter must be
